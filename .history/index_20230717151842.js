...
planetInput.id = 'planetInput';
planetInput.placeholder = 'Enter planet name';
...
let searchedPlanet = document.getElementById("planetInput").value;
...
planetInfo.innerText = `${searchedPlanet.synopsis}`;
planetElement.appendChild(planetInfo);

const planetImage = document.createElement("img");

planetInfo.textContent = `${searchedPlanet.name}: ${searchedPlanet.synopsis}`
planetImage.src = planetStuff.image;
planetInfo.appendChild(planetImage);
planetSection.appendChild(planetInfo);
}
